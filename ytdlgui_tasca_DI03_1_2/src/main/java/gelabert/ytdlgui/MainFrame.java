...
public MainFrame() {
    ...
    // 🔹 Crear component de polling
    pollingComponent = new MediaPollingComponent();
    // mateixa URL que l'ApiClient principal
    pollingComponent.setApiUrl("https://dimedianetapi9.azurewebsites.net");
    // per proves, que faci polling cada 10 segons
    pollingComponent.setPollingIntervalSeconds(10);

    // Listener per veure quan troba nous media (de moment, consola)
    pollingComponent.addMediaPollingListener(evt -> {
        java.util.List<Media> list = evt.getNewMedia();
        System.out.println(">>> MediaPolling: trobats " + list.size() +
...
public void onLoginSuccess(String token) {
    ...
    // 🔹 Configurar component de polling
